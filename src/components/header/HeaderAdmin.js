...
const HeaderAdmin = ({ isLoggedIn, color }) => {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <path
                ...
                fill={color === "branch-office" ? "#a442f1" : "black"}
              />
            </svg>
          </Link>
          <Link
          ...
          >
            ...
            >
              <path
                ...
                fill={color === "operators-panel" ? "#a442f1" : "black"}
              />
            </svg>
          </Link>
          <Link
          ...
          >
            ...
            >
              <path
                ...
                fill={color === "admin-panel" ? "#a442f1" : "black"}
              />
            </svg>
          </Link>
          <Link
          ...
          >
            <h3
              style={
                color === "dashboard" ? { color: "#a442f1" } : { color: "#000" }
              }
            >
              Reportes
            </h3>
            ...
            >
              <path
                ...
                fill={color === "dashboard" ? "#a442f1" : "black"}
              />
            </svg>
          </Link>
          <Link
